...
const BookDemo = () => {
  return (
    <section className="bg-black text-white min-h-screen">
      {/* Top banner with background image and heading */}
      <div
  className="w-full relative"
  style={{
    backgroundImage: "url('/assetes/test_book/1.jpg')",
    backgroundSize: "cover",
    backgroundPosition: "center", // shows the top part of the image
    ...
    <h1 className="text-4xl md:text-5xl font-bold text-white text-center">
      ...
      {/* Left: image */}
        <div className="w-full lg:w-1/2">
          <img
            src="/assetes/test_book/registration.jpg" // update image path as needed
            alt="Demo Visual"
          ...
          <form className="space-y-5">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="w-full">
                ...
                <select className="w-full bg-black border border-gray-700 p-3 rounded text-white">
